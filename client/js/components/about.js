...
const articles = {
  project: `
    ...
    <p>
      Brexit has the potential to influence a web of hundreds of factors. One way in which decisions of such complexity are made in business and in this project is by contructing an <strong>influence diagram</strong>. The diagram shows which factors influence one another. Under the hood there is a mathematical model which describes numerically how exactly those factors are conencted. Breaking down one big argument into small arguments about individual factors facilitates a focused discussion. At the same time, the underlying mathematical model binds everything together calculating the final conclusion.
    </p>
    <p>
  ...
  algo: `
    ...
    <p>
      ...
      <ol type="1">
        ...
        <li>The agent removes the option form the table that is the worst for him.</li>
        <li>Steps 1 and 2 repeat untill only one option is left.</li>
    ...
    <p>
      Significance of disagrements are indicated on the influence diagram by red exclamation marks. The significances are calculated in the following way.
      <ol type="1">
        <li>Answers from people who were recommnded the same Brexit option by the decision algorithm are combined to create average profiles.</li>
        <li>Total Brexit option values for each of the profiles are calculated.</li>
        <li>Then for each of the nodes in the diagram, answers of the profile are substituted by anwers in another profile and total values are recalculated.</li>
        <li>The ammount of points by which the total value shifted determines the significance of disagrement (low/significant/critical).</li>
      </ol>
    </p>
  `,
  future: `
    ...
    <h2>Stage 0</h2>
    <p>
      This was the previous stage dedicated to the project called Gitarg. Its aim was to explore the possibility of creating a tool analogous to Git but for argumetns/debates. Git allows very large groups of progrmmers to solve complex problmes by working independently on their separate parts. Gitarg could potentially create high quality arguments but it was also very formal and required very detailed and complex models to describe the subject matter. This stage has mostly involved research into argumentation, philosophy and some advanced computer algorithms.
    </p>
    <h2>Stage 1</h2>
    <p>
      This is the current stage dedicated to BrexitDiagram.uk. This website is an evolution of Gitarg which aims at finding a happy medium between formal and informal processes of argumentation. Its target audience is the general public interested in Brexit rather than people who want to build mathematical models themseves. During this stage I will continue to gather feedback and make adjustments to the website.
    </p>
    <h2>Stage 2</h2>
    <p>
      This stage will involve adding 3-5 other topics beside Brexit. This will help me to undestand how generalisable is this approach to argumentation and hopefully attract a wider audience.
    </p>
    <h2>Stage 3</h2>
    <p>
