const factors = {
  ...
  britishIdentity: {
    ...
    desc: `Scale: <strong>0</strong> = no impact; <strong>1</strong> = proportional impact (i.e. an increase in non-British population by 1% causes decrease in British identity by 1%); <strong>2</strong> = double impact.`,
  ...
  socialCohesion: {
    ...
    desc: `Scale: <strong>0</strong> = no impact; <strong>1</strong> = proportional impact (i.e. an increase in non-British population by 1% causes decrease social cohesion by 1%); <strong>2</strong> = double impact.`,
  ...
  unemployment: {
    ...
    desc: `Scale: <strong>0</strong> = no impact; <strong>1</strong> = proportional impact (i.e. an increase in non-British population by 1% causes increase in unemployment rate by 1%); <strong>2</strong> = double impact.`,
  ...
  medianIncome: {
    ...
    desc: `Scale: <strong>0</strong> = no impact; <strong>1</strong> = proportional impact (i.e. an increase in non-British population by 1% causes decrease in median income by 1%); <strong>2</strong> = double impact.`,
